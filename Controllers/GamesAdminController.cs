    ...
    public class GamesAdminController : Controller
    {
        ...
        public ActionResult SaveGames()
        {
            ...
            var games = new Game[]
            {
                ...
                {
                    Name="The Last Of Us",
                    Reviews=new Review[]{new Review { Critic=new Critic { Name="IGN"}, Score=9.5f, Text="Cool" } },
                    ...
                    Types = new[] {Type.PS3, Type.PS4, Type.PS5, Type.PC, Type.SteamDeck},
                    MinAge=18,
                    Rating=9.1f,
                ...
                {
                    Name="God of War",
                    Reviews=new Review[]{new Review { Critic=new Critic { Name="Igromania"}, Score=9.0f, Text="Wonderful" } },
                    ...
                    Types = new[] { Type.PS4, Type.PS5, Type.PC, Type.SteamDeck},
                    MinAge=18,
                    Rating=9.0f,
